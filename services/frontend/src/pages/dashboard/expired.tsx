...
const Expired = ({ listingsData }) => {
  ...
  return (
    <>
      <Head>
        <title>Expired Listings Dashboard | auctionweb.site</title>
        <meta name="viewport" content="initial-scale=1.0, width=device-width" />
      </Head>
      <DashboardBreadcrumbs
        name="Expired Listings Dashboard"
        link="/dashboard/expired"
      />
      <section className="py-3">
        <h3 className="text-3xl leading-tight font-semibold font-heading">
          Expired Listings Dashboard
        </h3>
        <p className="mt-1 max-w-2xl text-l text-gray-500">
          See all the listings you have created that expired
        </p>
        <DashboardTabs />
