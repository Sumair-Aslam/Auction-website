...
const Listings = ({ listingsData }) => {
  ...
  return (
    <>
      <Head>
        <title>Listings Dashboard | auctionweb.site</title>
        <meta name="viewport" content="initial-scale=1.0, width=device-width" />
      </Head>
      <DashboardBreadcrumbs
        name="Your Listings Dashboard"
      ...
      <section className="py-3">
        ...
        <p className="mt-1 max-w-2xl text-l text-gray-500">
          View all the listings you have created
        </p>
        <DashboardTabs />
...
Listings.getInitialProps = async (context: NextPageContext, client: any) => {
  try {
